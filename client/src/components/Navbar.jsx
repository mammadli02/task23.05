...
const Navbar = () => {
  return (
   ...
   <section style={{backgroundImage:'URL(https://preview.colorlib.com/theme/robotics/img/banner-bg.jpg.webp)', padding:"30px 150px" }}>
...
{/* <div style={{display:'flex',marginTop:'300px',justifyContent:'space-between', height:'50vh', alignItems:'center',width:"90%" }}>
<div style={{width:'50%' }}>
